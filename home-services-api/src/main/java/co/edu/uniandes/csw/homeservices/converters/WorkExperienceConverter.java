...
public abstract class WorkExperienceConverter {
     ...
     * al atributo org.eclipse.uml2.uml.internal.impl.PropertyImpl@3426402a (name: contractor, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false) de WorkExperienceEntity. Se usa cuando se necesita convertir
     ...
     * actualizar varios WorkExperienceEntity con el mismo org.eclipse.uml2.uml.internal.impl.PropertyImpl@3426402a (name: contractor, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false)
     * @param dtos Colección de instancias de WorkExperienceDTO
     * @param parent Instancia de ContractorEntity
     * @return Colección de WorkExperienceEntity con el atributo org.eclipse.uml2.uml.internal.impl.PropertyImpl@3426402a (name: contractor, visibility: <unset>) (isLeaf: false) (isStatic: false) (isOrdered: false, isUnique: true, isReadOnly: false) (aggregation: none, isDerived: false, isDerivedUnion: false, isID: false) asignado
     * @generated
     */
